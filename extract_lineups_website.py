...
page = urllib.urlopen("https://www.fiba.basketball/basketballworldcup/2023/game/2708/Lebanon-Canada")
...
content = soup.find_all('div', {'class': 'play-by-play_content'})

pbpQ1 = content[0][0].find_all('div', {'class': 'actions-list period_select_dependable'})
pbpQ2 = content[0][1].find_all('div', {'class': 'actions-list period_select_dependable'})
pbpQ3 = content[0][2].find_all('div', {'class': 'actions-list period_select_dependable'})
pbpQ4 = content[0][3].find_all('div', {'class': 'actions-list period_select_dependable'})
